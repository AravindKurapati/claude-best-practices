...
A living knowledge base of best practices for working with Claude, Claude Code, skills, MCP tools, and agentic workflows — collected from practitioners, researchers, and the community.

---

## What This Is

This repo is a personal knowledge base I've been building while learning Claude Code and agentic workflows. Everything here comes from real practitioners sharing what actually works — Twitter threads, blog posts, Anthropic's official guides, and hands-on experience.
...
If you've found a best practice that belongs here — a workflow, a pattern, a tool, a tip from someone in the community — open a PR or an issue.
